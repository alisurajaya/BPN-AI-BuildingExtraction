...
def regularization(rgb, ins_segmentation, model, in_mode="semantic", out_mode="semantic", min_size=10):
...
def regularize_segmentations(img_folder, seg_folder, out_folder, in_mode="semantic", out_mode="semantic", samples=None):
    """
...
regularize_segmentations(img_folder=var.INF_RGB, seg_folder=var.INF_SEG, out_folder=var.INF_OUT, in_mode="semantic", out_mode="semantic", samples=None)
